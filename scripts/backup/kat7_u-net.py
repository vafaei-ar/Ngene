...
from unetdataprovider import DataProvider
...
dpt = DataProvider(nx=nx,ny=ny,a_min=0, a_max=200, files=files_list,label_name='mask',n_class=2)
...
for qq in range(30):
    ...
    net = unet.Unet(channels=dpt.channels, 
                n_class=2, 
                layers=layers, 
